...
module.exports = {
    ...
    addApplication: async (message, userId, reason, loaduration) => {
        return new Model({
    ...
    findApplication: async (guildId, messageId) => {
        return Model.findOne({ guild_id: guildId, message_id: messageId });
    },

    deleteApplicationDB: async (guildId, messageId, memberId, reason) => {
